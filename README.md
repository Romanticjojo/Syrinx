...
| **macOS**（Apple Silicon） | `Syrinx-0.3.0-mac-arm64.dmg` | [GitHub Release](https://github.com/Romanticjojo/Syrinx/releases/latest) · [夸克网盘](https://pan.quark.cn/s/85ed33fc5a67) |
...
**一方随身曲库。** 导入 MusicXML、XML 或 MXL，把曲名、作曲、标签和封面整理好；文件夹、收藏、搜索、分页，数据全部留在你自己的设备上。详见下方[个人乐谱仓库](#个人乐谱仓库)。

**翻开就能练。** 单长笛谱直接翻页阅读；带钢琴声部的乐谱可选本机合成伴奏——四拍倒数起奏、点小节定位、0.5–1.5 倍保调变速，演奏完回听录音并查看逐音音高对比。

**精选曲库开箱即用。** 五首钢琴伴奏曲目（Luv Letter、Flower Dance、Lumière、Alicia、Interstellar）随仓库与安装包分发：动态封面、循环背景视频、精确对齐的采样钢琴伴奏，无需导入任何文件。详见下方[精选曲目的沉浸式演奏](#精选曲目的沉浸式演奏)。

## 个人乐谱仓库

导入自己的 MusicXML / XML / MXL，就有一方随身的曲库——数据全部保存在你自己的设备上。

<p align="center">
  <img src="docs/img/readme/library-desktop.png" alt="个人仓库书架：导入的两份乐谱、搜索与视图切换" width="100%" />
  <br /><sub>个人仓库 · 导入即整理，卡片与列表两种视图</sub>
</p>

**收藏与整理。** 导入时自动识别曲名、声部与拍号；之后可编辑信息、设置 PNG / JPEG / WebP 封面、用文件夹分组、收藏常练曲目、按曲名或作者搜索。

**翻开就能练。** 单长笛谱直接翻页阅读；带钢琴声部的乐谱可选「原谱钢琴伴奏」本机合成——试听满意后点「开始演奏」，四拍倒数起奏、点小节定位、0.5–1.5 倍保调变速。

<table>
  <tr>
    <td width="50%"><img src="docs/img/readme/library-list.png" alt="个人仓库列表视图：曲名、作者与乐谱信息一览" width="100%" /></td>
    <td width="50%"><img src="docs/img/readme/practice-tempo.png" alt="Morning Light 乐谱页：钢琴伴奏设置与开始演奏" width="100%" /></td>
  </tr>
  <tr>
    <td align="center"><sub>列表视图，适合快速查找</sub></td>
    <td align="center"><sub>带钢琴声部的乐谱：先试听，再开始演奏</sub></td>
  </tr>
</table>

仓库自带两份原创小练习（`docs/examples/` 中的 Morning Light 与 Breath Study）可直接导入体验；从仓库菜单可随时导出备份。
